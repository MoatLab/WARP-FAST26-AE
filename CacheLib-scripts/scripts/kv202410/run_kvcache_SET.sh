...
sudo ./5.get_waf_${dev_name}.sh &
wakeup_pid=$!
sudo ./6.get_bw_${dev_name}.sh &
wakeup_pid2=$!
...
sudo ./cachebench \
 -json_test_config ${config_dir}/fdp_enabled_config_soc40_excel_${dev_name}_SETONLY.json \
 -progress_stats_file=${output_dir}/kvcache202206_soc40.log 
