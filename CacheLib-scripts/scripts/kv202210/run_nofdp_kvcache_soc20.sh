...
# ------------ cachebench ------------ #
sudo ./cachebench \
 -json_test_config ${config_dir}/nofdp_disabled_config_soc20_excelx2_SETONLY.json \
 -progress_stats_file=${output_dir}/kvcache202210_nofdp20_soc20_nvme0-Aug31.log 
# --------------- kill --------------- #
sleep 2000
